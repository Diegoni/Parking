...
<?php do {?>
<tr>
	<th><?php echo $row_tarifa['tipo']?></th>
...
<form action="config.php" name="tarifas">
<tr>
	<td><input size="25" type="text" name="estacionamiento" value="<?php echo $row_estacionamiento['estacionamiento']?>"></td>
	<td><input size="5" type="text" name="cant_lugares" value="<?php echo $row_estacionamiento['cant_lugares']?>"></td>
</tr>
<tr>
	<td align="center" colspan="6">
